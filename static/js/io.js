...
function getCSVHeaders(type) {
    switch (type) {
        ...
        case 'Shooting':
            return ['associated_ground_id', 'ground_callsign', 'timestamp', 'launch_location_x', 'launch_location_y', 'original_ground_x', 'original_ground_y', 'target_x', 'target_y', 'ammo_type'];
        case 'EnemySpot':
            return ['timestamp', 'x', 'y', 'desc', 'callsign', 'associated_ground_id', 'ground_callsign', 'original_ground_x', 'original_ground_y'];
        case 'Report':
            return ['timestamp', 'x', 'y', 'desc', 'callsign', 'associated_ground_id', 'ground_callsign', 'original_ground_x', 'original_ground_y'];
        case 'Targets':
            return ['creation_time', 'x', 'y', 'target_type'];
