...
function addFrame() {
    ...
    // Save to undo stack
    undoStack.push({
        action: 'addFrame', objectType: selectedObject.type, objectId: selectedObject.id, timestamp: currentTime
    });

    obj.frames.push({
        timestamp: currentTime, x: lastPosition.x, y: lastPosition.y
    });
